...
|---|---|---|---|---|
| 1 | F08-T01 | Document Drift schema + DAOs | documents + related tables (§12) + migration | TODO |
| 2 | F08-T02 | Save-result-only | default; no image; summary/info/dates persisted | TODO |
