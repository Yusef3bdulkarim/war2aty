...
| 6 | F07-T06 | Key-information items | confidence bands; «راجع المعلومة» label | DONE |
| 7 | F07-T07 | Dates & times | list with roles | DONE |
| 8 | F07-T08 | Multi-date selection | «اختار التاريخ» (event vs display) | DONE |
| 9 | F07-T09 | Missing-time rules | never fabricate time; «مافيهاش وقت» | DONE |
| 10 | F07-T10 | Amounts + required docs + instructions | sections render | DONE |
